...
public class NetUtil {
    ...
    public static void onNetChange(Context context) {
        if (MyApplication.mNetState == NetUtil.NETWORN_NONE
...
//		        dialog.setCancelable(false);// 设置对话框不可取消
        ...
        } else if (MyApplication.mNetState == NetUtil.NETWORN_MOBILE) {
//            ActivityHelper.showTips("当前为手机网络");
        } else if (MyApplication.mNetState == NetUtil.NETWORN_WIFI) {
