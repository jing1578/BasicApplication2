 ...
 *
 */
public class LocalImageCycleView extends LinearLayout {
    /**
     * 上下文
     */
     ...
     * @param context
     */
    public LocalImageCycleView(Context context) {
        super(context);
        init(context);
    }
     ...
     * @param attrs
     */
    public LocalImageCycleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
     ...
     *
     */
    public void setImageResources(ArrayList<String> imageDesList, ArrayList<Integer> imageUrlList, LocalImageCycleViewListener imageCycleViewListener) {
    ...
    private class ImageCycleAdapter extends PagerAdapter {
         ...
         * 广告图片点击监听
         */
        private LocalImageCycleViewListener mImageCycleViewListener;

        private Context mContext;

        public ImageCycleAdapter(Context context, ArrayList<Integer> adList, ArrayList<String> nameList, LocalImageCycleViewListener imageCycleViewListener) {
...
//			return mAdList.size();
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            int imageUrl =mAdList.get(position % mAdList.size()).intValue();
            View view;
     ...
     * @author minking
     */
    public interface LocalImageCycleViewListener {
